<div>
	<div class="page-hd" style="background-image: url(<?php print $site_url; ?>images/ranking.png)">
		<div class="bd-c">
			<h2 class="pre-social"><?php print $lang['ranking']; ?> - <?php print $lang['players']; ?></h2>
		</div>
	</div>
	<div class="padding-container">
		...
		<ul class="nav nav-tabs">
			<li class="nav open">
				<a class="nav-link" href="#"><img src="<?php print $site_url; ?>images/players.png" alt="<?php print $lang['players']; ?>" title="<?php print $lang['players']; ?>"> <?php print $lang['players']; ?></a>
			</li>
			<li class="nav">
