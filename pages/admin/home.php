...
<div class="list-group">
	...
	<a href="<?php print $site_url; ?>admin/modules" class="list-group-item list-group-item-action">
		<h3 class="list-group-item-heading"><i class="fa fa-plug fa-1" aria-hidden="true"></i> <?php print $lang['modules-management']; ?></h3>
		<p class="list-group-item-text" style="color: #0ce3ac;"><?php print $lang['modules-management-info']; ?></p>
	</a>
	<a href="<?php print $site_url; ?>admin/themes" class="list-group-item list-group-item-action">
		<h3 class="list-group-item-heading"><i class="fa fa-file-image-o fa-1" aria-hidden="true"></i> <?php print $lang['themes']; ?></h3>
		<p class="list-group-item-text" style="color: #0ce3ac;"><?php print $lang['themes-info']; ?></p>
	</a>
</div>
<?php } ?>